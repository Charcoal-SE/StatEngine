...
$data = array("site" => 'datascience', "key" => "WFiOehV2MzNIFYyUbvtNRg((");
...
mysql_query("INSERT INTO `stats` (`total_questions`, `total_unanswered`, `total_accepted`, `total_answers`, `questions_per_minute`, `total_comments`, `total_votes`, `total_badges`, `badges_per_minute`, `total_users`, `new_active_users`, `site`) VALUES (" . $obj->{'items'}[0]->{'total_questions'} . ", " . $obj->{'items'}[0]->{'total_unanswered'} . ", " . $obj->{'items'}[0]->{'total_accepted'} . ", " . $obj->{'items'}[0]->{'total_answers'} . ", " . $obj->{'items'}[0]->{'questions_per_minute'} . ", " . $obj->{'items'}[0]->{'total_comments'} . ", " . $obj->{'items'}[0]->{'total_votes'} . ", " . $obj->{'items'}[0]->{'total_badges'} . ", " . $obj->{'items'}[0]->{'badges_per_minute'} . ", " . $obj->{'items'}[0]->{'total_users'} . ", " . $obj->{'items'}[0]->{'new_active_users'} . ", 'datascience'" . ");");
